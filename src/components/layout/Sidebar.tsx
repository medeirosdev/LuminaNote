                    ...
                    <AnimatePresence>
                        {!isCollapsed && (
                            <motion.div
                                ...
                                animate={{ opacity: 1 }}
                                exit={{ opacity: 0 }}
                                className="mt-4 pt-4 border-t border-zen-border"
                            >
                                <button
                                    onClick={() => setShowAbout(true)}
                                    className="w-full text-center text-xs text-zen-text-muted hover:text-zen-accent transition-colors cursor-pointer"
                                >
                                    <span className="block">Created by</span>
                                    <span className="font-medium text-zen-text-secondary hover:text-zen-accent">
